...
> ⚠️ この操作で **純正 TRCC は使えなくなります**。元に戻すにはデバイス
...
詳細は [`trofeo/protocol.py`](trofeo/protocol.py) と
[thermalright-trcc-linux/doc/PROTOCOL_USBLCDNEW.md](https://github.com/Lexonight1/thermalright-trcc-linux/blob/main/doc/PROTOCOL_USBLCDNEW.md)。
